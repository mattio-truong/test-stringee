<template>
	<div id="wp-footer">
		...
		<footer class="site-footer">
			<div class="site-footer-legal">Copyright © 2018 <a href="http://themeforest.net/item/remark-responsive-bootstrap-admin-template/11989202">Stringee</a>. All rights reserved.</div>
