<template>	
	<div id="wp-contactBody">
		<link rel="stylesheet" href="/static/theme/mmenu/assets/examples/css/apps/contacts.css">
		<!-- Page -->
			...
			<div class="page bg-white">
				...
				<div class="page-main">
				  ...
				  <div id="contactsContent" class="page-content page-content-table" data-plugin="selectable">
					...
					<!-- Contacts -->
					<!-- component/table_contact_list.php -->
...
<script>
	import FooterCommon from "./_common/footer";
    export default {
		components:{
			FooterCommon
		}
